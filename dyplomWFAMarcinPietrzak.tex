...
\caption{Różny rodzaj poruszania się w programię}
\label{ref:ref}
\end{figure}

\subsection{Cześć Galerii Programu}

W części galerii możesz dowiedzieć się o danym modelu

\subsection{Część pokazowa modeli programu programu}

W części galerii możesz możesz zobaczyć jak model wygląda w ruchu. Modele obsługuję się za pomocą kontrolerów ruchowych. W zależności od modelu interakcja wygląda trochę inaczej, szczegółowo każda zostanie omówiona w sekcji dotyczącej danego modelu.
